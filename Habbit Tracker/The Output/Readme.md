...
## Complete, corrected Chrono Loot codebase

This is the **full, drop-in DataviewJS block** with all requested behavior restored and aligned.

### What this version guarantees

* Week **always starts on Monday**
* **Diamond shape only for 100%** (reward state)
* Triangle for all other values with **graded gold intensity**
* Three sort modes

  * Default (Mon → Sun)
  * Ascending (least → most)
  * Descending (most → least)
...
* **Shape change marks perfection**, not just color
* **Gold intensity encodes failure, effort, and excellence**
* Sorting works identically to your other dashboards
* Monday anchoring removes ambiguity
* Nothing is decorative without meaning

This module is now **behaviorally correct**, not just visually pleasing.
