...
if (dailyStats.length === 0) {
    ...
    // CHART TITLE ICONS (Hive and Haxe)
    const iconHive = `<svg viewBox="0 0 24 24" fill="${iconColor}"><path d="M12 0l-4 2.31v4.62L12 9.24l4-2.31V2.31L12 0zm8 4.62l-4 2.31v4.62l4 2.31l4-2.31V6.93l-4-2.31zM4 4.62L0 6.93v4.62l4 2.31l4-2.31V6.93L4 4.62zm8 9.24l-4 2.31v4.62L12 23.1l4-2.31v-4.62l-4-2.31z"/></svg>`;
    const iconHaxe = `<svg viewBox="0 0 24 24" fill="${iconColor}"><path d="M3.5 3.5L8 12l-4.5 8.5h3L11 12l-4.5-8.5h-3zm14 0l-4.5 8.5L17.5 20.5h3l4.5-8.5l-4.5-8.5h-3zM8.5 7L12 10.5 15.5 7h-7zm0 10h7L12 13.5 8.5 17z"/></svg>`;
